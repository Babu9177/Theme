...
class tv9_section_top_ad_widget extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'tv9_section_top_ad_widget', esc_html__('Veegam News: Top SECTION with Ad Widget', 'veegam'), $widget_ops, $control_ops );
	}
            ...
            <div class="col-sm-12">
                ...
                <?php } endwhile; wp_reset_postdata(); ?>
                 ...
                 <div class="gads">
                     ...
                     <?php echo html_entity_decode($adcode); ?>
                </div>
...
<?php } endwhile; wp_reset_postdata(); ?>
					 ...
					 <div class="col-sm-3 mt-3">
                 <div class="gads">
                    <img src="img/Ad-MediumRectangle-300x250.jpg" class="float-right" alt="ads" width="100%" >

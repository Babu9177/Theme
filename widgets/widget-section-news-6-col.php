...
add_action( 'widgets_init', 'tv9_section_news_6_col_load_widgets' );

function tv9_section_news_6_col_load_widgets() {
	register_widget( 'tv9_section_news_6_col_widget' );
}

class tv9_section_news_6_col_widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'tv9_section_news_6_col_widget', 'description' => esc_html__('Top section display posts in a row.', 'tv9-news') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 50, 'height' => 50, 'id_base' => 'tv9_section_news_6_col_widget' );

		/* Create the widget. */
		parent::__construct( 'tv9_section_news_6_col_widget', esc_html__('NEWS 6 COL Widget', 'veegam'), $widget_ops, $control_ops );
	}

...
class tv9_home_feat1_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
								...
								while($recent->have_posts()) : $recent->the_post(); { ?>
									...
									<div class="col-md-4">
											...
											<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
												<?php the_post_thumbnail('tv9-mid-thumb', array( 'class' => 'tv9-reg-img lazy' )); ?>
		  ...
		  <p class="post-info"><?php echo $title ?> | <span class="post-meta"><?php printf( esc_html__( '%s ago', 'veegam-news' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span></p>
